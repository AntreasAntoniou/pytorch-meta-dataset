...
class EpisodePiece(
    ...
    def unique_class_ids(self):
        ...
        return compute_unique_class_ids(
            tf.concat(
                (
                    distribute_utils.aggregate(self.support_class_ids),
                    distribute_utils.aggregate(self.query_class_ids),
                ),
                -1,
            )
        )
    ...
    def support_shots(self):
        ...
        return compute_shot(self.way, distribute_utils.aggregate(self.support_labels))
